...
from Edith import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
...
# from Edith.modules.rules import get_rules
import Edith.modules.sql.rules_sql as rulessql

# from Edith.modules.sql import warns_sql as warnssql
import Edith.modules.sql.blacklist_sql as blacklistsql
from Edith.modules.sql import disable_sql as disabledsql

# from Edith.modules.sql import cust_filters_sql as filtersql
# import Edith.modules.sql.welcome_sql as welcsql
...
def export_data(update, context):
    ...
    with open("Edith{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Edith{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Edith-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
