...
from Edith import OWNER_ID
from Edith import TEMP_DOWNLOAD_DIRECTORY as path
from Edith import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
water = './Edith/resources/Edith.jpg'
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./Edith/modules/{}.py".format(input_str)
...
from Edith.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "Edith/modules/",  # pylint:disable=E0602
                )
            )
...
from Edith import telethn as tbot, OWNER_ID, DEV_USERS
from Edith.events import register
import os
import asyncio
import os
...
from pathlib import Path
from Edith import telethn as borg
