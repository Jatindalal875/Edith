...
from Edith import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Edith/modules/{shortname}.py")
        name = "Edith.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Edith.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Edith/modules/*.py"
